...
existe.covid    <- existe.nowcasting2(escala = escala, sigla = sigla, tipo = "covid")
existe.srag     <- existe.nowcasting2(escala = escala, sigla = sigla, tipo = "srag")
existe.ob.covid <- existe.nowcasting2(escala = escala, sigla = sigla, tipo = "obitos_covid")
existe.ob.srag  <- existe.nowcasting2(escala = escala, sigla = sigla, tipo = "obitos_srag")
...
if (existe.covid) {
  data.covid <- get.data.base2(escala, sigla, "covid")
...
if (existe.srag) {
  data.srag <- get.data.base2(escala, sigla, "srag")
...
if (existe.ob.covid) {
  data.ob.covid <- get.data.base2(escala, sigla, "obitos_covid")
...
if (existe.ob.srag) {
  data.ob.srag <- get.data.base2(escala, sigla, "obitos_srag")

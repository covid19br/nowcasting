...
if(all_models){
  ...
  load(file.path(PRJROOT, "Curve_fitting/output/HospitalStats/hospitalStatsFits.Rdata"))
...
save(time_fits0, time_fits1, probsFits, 
     file = file.path(PRJROOT, "Curve_fitting/output/HospitalStats/hospitalStatsFits.Rdata"))
